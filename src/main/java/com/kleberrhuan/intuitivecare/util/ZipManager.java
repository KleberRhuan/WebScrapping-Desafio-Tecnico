...
public class ZipArchiver implements Archiver {
     ...
     * @param archiveName The name of the archive (used as part of the ZIP file name).
    ...
    /**
     * Copies the content of the file into the ZIP output stream using a BufferedInputStream.
     *
