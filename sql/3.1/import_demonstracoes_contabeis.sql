...
-- Restrição NOT NULL removida conforme solicitado
...
-- Procedure melhorada para importar CSVs com melhor tratamento de erros e feedback
...
-- Você pode descomentar e modificar estas linhas conforme necessário
BEGIN;
...
-- ANÁLISE: Execute este comando para ver se a importação funcionou
